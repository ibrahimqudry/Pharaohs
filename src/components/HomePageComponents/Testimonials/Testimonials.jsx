...
function Testimonials() {
  const testimonialsData = [
    ...
    },
    {
      ...
      title: 'رئيس الرابطة العالمية للأشراف الأدارسة',
      text: 'أشاد سماحة السيد إدريس الشريف الإدريسي، رئيس الرابطة العالمية للسادة الأشراف الأدارسة، بالدور البارز الذي تقوم به مجموعة الفراعنة في الاستثمار والتطوير العقاري. وأكد أهمية مساهمة الشباب الواعد في النهضة العمرانية وبناء مستقبل مشرق للبلاد.',
    },
    {
      image: '/images/ahmed-saleh.jpg',
      name: 'اللواء أحمد صالح',
      title: "عضو مجلس نواب عن محافظة أسوان",
      text: 'ما نشهده اليوم من تعاون بين الشباب الطموح ومجموعة الفراعنة، بدعم من الجامعات الوطنية، هو نموذج مُشرف لتكامل الجهود من أجل مستقبل أسوان الجديدة. هذه المشروعات ليست مجرد استثمار، بل خطوة نحو بناء مجتمع واعٍ، منتج، ومُستقر.'
    },
