...
function Testimonials() {
  const testimonialsData = [
    ...
    },
    {
      ...
      text: 'أشاد سماحة السيد إدريس الشريف الإدريسي، رئيس الرابطة العالمية للسادة الأشراف الأدارسة، بالدور البارز الذي تقوم به مجموعة الفراعنة في الاستثمار والتطوير العقاري. وأكد أهمية مساهمة الشباب في النهضة العمرانية وبناء مستقبل مشرق للبلاد.',
    },
    {
